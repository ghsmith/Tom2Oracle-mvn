...
// Generated Sep 18, 2015 10:49:03 PM by Hibernate Tools 4.3.1
...
public class Expression  implements java.io.Serializable {
    ...
    public Expression(BigDecimal expressionSaid, String libraryPrep, String sampleName, String pipeline, String geneId, String geneName, BigDecimal fpkm, BigDecimal fpkmConfLo, BigDecimal fpkmConfHi, BigDecimal estimatedCounts) {
       this.expressionSaid = expressionSaid;
       this.libraryPrep = libraryPrep;
       this.sampleName = sampleName;
       this.pipeline = pipeline;
