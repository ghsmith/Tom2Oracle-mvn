...
// Generated Oct 9, 2016 9:40:00 PM by Hibernate Tools 4.3.1
...
public class Mafannovar  implements java.io.Serializable {
    ...
    @Column(name="VARIANT_TYPE", length=2000)
    ...
    @Column(name="REFERENCE_ALLELE", length=1000)
    ...
    @Column(name="TUMOR_SEQ_ALLELE1", length=1000)
    ...
    @Column(name="TUMOR_SEQ_ALLELE2", length=1000)
    ...
    @Column(name="MATCH_NORM_SEQ_ALLELE1", length=1000)
    ...
    @Column(name="MATCH_NORM_SEQ_ALLELE2", length=1000)
    ...
    @Column(name="DBSNP_VAL_STATUS", length=2000)
    ...
    @Column(name="HGVSP_SHORT", length=1000)
    ...
    @Column(name="FEATURE_TYPE", length=1000)
    ...
    @Column(name="CDNA_POSITION", length=1000)
    ...
    @Column(name="CDS_POSITION", length=1000)
    ...
    @Column(name="PROTEIN_POSITION", length=1000)
    ...
    @Column(name="AMINO_ACIDS", length=1000)
    ...
    @Column(name="CODONS", length=1000)
    ...
    @Column(name="SYMBOL", length=1000)
    ...
    @Column(name="SYMBOL_SOURCE", length=1000)
    ...
    @Column(name="HGNC_ID", length=1000)
    ...
    @Column(name="BIOTYPE", length=1000)
    ...
    @Column(name="CANONICAL", length=1000)
    ...
    @Column(name="SWISSPROT", length=1000)
    ...
    @Column(name="UNIPARC", length=1000)
    ...
    @Column(name="SIFT_MAF", length=1000)
    ...
    @Column(name="POLYPHEN_MAF", length=1000)
    ...
    @Column(name="INTRON", length=1000)
