...
public class Mafannovar  implements java.io.Serializable {
    ...
    @Column(name="AMINO_ACID_CHANGE", length=2000)
    ...
    @Column(name="CHROMOSOME", precision=22, scale=0)
